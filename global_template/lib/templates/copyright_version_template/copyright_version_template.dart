...
class CopyRightVersion extends StatelessWidget {
  const CopyRightVersion({
    this.copyRight = 'Copyright \u00a9 Puspapharma',
            ...
            Consumer<GlobalProvider>(
              builder: (_, globalProvider, __) => Text(
                showOnlyVersion
                    ...
                    : 'Version ${globalProvider.versionPackageInfo}' /*'${globalProvider.appNamePackageInfo} | Version ${globalProvider.versionPackageInfo}'*/,
