...
class _FormUserState extends State<FormUser> {
  String username, password, fullName, deviceid;
    ...
    return Column(
      children: [
        ...
        Selector2<GlobalProvider, GlobalProvider, Tuple2<bool, bool>>(
          selector: (_, loading, register) =>
              Tuple2(loading.isLoading, register.isRegister),
          builder: (_, value, __) {
            return value.item1
        ...
        Selector<GlobalProvider, bool>(
          ...
          builder: (_, isRegister, __) {
            return OutlineButton(
              ...
              onPressed: () =>
                  context.read<GlobalProvider>().setRegister(!isRegister),
            );
          },
        )*/
      ],
