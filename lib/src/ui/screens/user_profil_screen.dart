              ...
              child: Column(
                children: [
                  ...
                  Align(
                    ...
                    child: Selector<GlobalProvider, bool>(
                      selector: (_, globalProvider) =>
                          globalProvider.isImageLoading,
                                ...
                                children: [
                                  InkWell(
                                    ...
                                    child: ShowImageNetwork(
                                      imageUrl:
                                          '${appConfig2.baseImageApiUrl}/user/${user.image}',
                                      isCircle: true,
                                      alignment: Alignment.center,
  ...
  Future<void> _userUpdateImage(BuildContext context) async {
    ...
    if (imagePicker == null) {
      ...
      try {
        ...
        final result = await userProvider.userUpdateImage(
            userProvider.user.idUser, imageFile);
        await userProvider.saveSessionUser(list: result);
        await globalF.showToast(
            message: 'Berhasil Update Gambar Profile ', isSuccess: true);
  ...
  Future<void> _userUpdateFullName(BuildContext context) async {
    ...
    if (form.validate()) {
      ...
      try {
        ...
        final result = await userProvider.userUpdateFullName(
            userProvider.user.idUser, fullName);
        await userProvider.saveSessionUser(list: result);
        await globalF.showToast(
            message: 'Berhasil Update Nama Lengkap', isSuccess: true);
      ...
      await globalF.showToast(
          message: 'Form Tidak Lengkap', isError: true, isLongDuration: true);
    }
  }
}
