  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        ...
        UserProfilScreen.routeNamed: (BuildContext context) =>
            UserProfilScreen(),
        AddDestinationScreen.routeNamed: (BuildContext context) =>
            AddDestinationScreen(),
        PickDestinationScreen.routeNamed: (BuildContext context) =>
